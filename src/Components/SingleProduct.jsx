    ...
    <>
      <div className="lg-flex-row flex justify-between w-full">
        ...
        <div className="w-1/2 mt-6 px-12">
          <h2 className="font-semibold text-5xl mb-6 capitalize w-full">
            Title: {data.product_name}
          </h2>
          <p>
            <span className="text-2xl my-4 w-full">
          ...
          <div className="flex w-full justify-between mb-6">
            ...
            <div className="flex justify-evenly w-3/5">
              <button
                className="bg-gray-300 w-14 text-xl w-14 h-10"
                onClick={QuantitySub}
              >
                {" "}
                -{" "}
              ...
              <button
                className="bg-gray-300 w-14 text-xl h-10"
                onClick={QuantityAdd}
              >
                {" "}
                +{" "}
          ...
          {data?.stock > 0 ? (
            <>
              <button
                onClick={() => AddtoCart()}
                className="w-full mt-8 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-200"
              >
                Shop Now
              </button>
            </>
